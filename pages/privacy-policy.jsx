  ...
  return (
    <div className="flex flex-col items-center justify-center p-6">
      <div className="text-start leading-loose text-lg font-medium lg:w-[50%]">
        ...
        <p className="mb-4">
          This privacy policy applies to the Oupoun app (hereby referred to as{' '}
          <strong>"Application"</strong>) for mobile devices that was created by{' '}
          <strong>Opal World</strong> (hereby referred to as{' '}
          <strong>"Service Provider"</strong>) as a Free service. This service
          is intended for use <strong>"AS IS"</strong>.
        </p>
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Third Party Access</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Opt-Out Rights</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Data Retention Policy</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Security</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold mt-6 mb-4">Changes</h3>
        <p className="mb-4">
        ...
        <p className="mb-4">
          This privacy policy is effective as of <strong>2024-11-29</strong>.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-4">Your Consent</h3>
        <p className="mb-4">
